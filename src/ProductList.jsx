...
function ProductList({ onHomeClick }) {
    ...
    // Calculate total quantity for the cart icon dynamically [cite: 27, 72, 75]
    ...
    const handleAddToCart = (plant) => {
        dispatch(addItem(plant)); // Dispatch to Redux [cite: 62, 70]
    };
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                {/* Dynamic total quantity display [cite: 27, 75] */}
                                {totalQuantity > 0 && <span className="cart-quantity-count">{totalQuantity}</span>}
                            </h1>
                        </a>
                    </div>
                </div>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        {/* Button disables if item is in cart [cite: 71] */}
                                        <button 
